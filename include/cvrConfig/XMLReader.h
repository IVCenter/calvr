...
class CVRCONFIG_EXPORT XMLReader : public ConfigFileReader
{
    public:
        ...
        float getFloat(std::string attribute, std::string path, float def = 0.0,
                bool * found = NULL);

        double getDouble(std::string path, double def = 0.0,
                bool * found = NULL);

        double getDouble(std::string attribute, std::string path, double def =
                0.0, bool * found = NULL);
        ...
        bool getBool(std::string attribute, std::string path, bool def = false,
                bool * found = NULL);
        ...
        osg::Vec3d getVec3d(std::string path,
                osg::Vec3d def = osg::Vec3d(0,0,0), bool * found = NULL);
