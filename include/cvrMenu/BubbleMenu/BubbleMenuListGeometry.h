#ifndef BUBBLE_MENU_LIST_GEOMETRY_H
#define BUBBLE_MENU_LIST_GEOMETRY_H
...
class BubbleMenuListGeometry : public BubbleMenuGeometry
{
    public:
        BubbleMenuListGeometry();
        virtual ~BubbleMenuListGeometry();
