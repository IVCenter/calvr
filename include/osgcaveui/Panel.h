...
namespace cui
{
  ...
  class CUIEXPORT Panel : public cui::Widget, public cui::Events, public cui::CardListener
  {
    public:
      ...
      osg::Geode* getPanelGeode() { return _panelGeode; }
      Movability getMovability() { return _moveMode; }
      int  getRows() { return _numRows; }
      int  getCols() { return _numCols; }
      float getScale() { return _scaleFact; }
      void setWidth(float);
      ...
      void setBGColor();
      osg::Vec4 getBGColor() { return (*_BGcolor)[0]; }
