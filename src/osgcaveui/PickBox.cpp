...
PickBox::PickBox(Interaction* interaction, const Vec3& min, const Vec3& max, 
  const Vec4& c1, const Vec4& c2, const Vec4& c3) : Widget(), Events()
{
  _switch = new Switch();
  ...
  // INTERACTION
  /*_interactionA = new covise::coTrackerButtonInteraction(covise::coInteraction::ButtonA,"MoveMode",covise::coInteraction::Medium);
  _interactionB = new covise::coTrackerButtonInteraction(covise::coInteraction::ButtonB,"MoveMode",covise::coInteraction::Medium);
  _interactionC = new covise::coTrackerButtonInteraction(covise::coInteraction::ButtonC,"MoveMode",covise::coInteraction::Medium);
...
PickBox::~PickBox()
{
  ...
  /*if(_interactionA)
  {
    if(_interactionA->isRegistered())
       covise::coInteractionManager::the()->unregisterInteraction(_interactionA);
  ...
  if(_interactionB)
  {
    if(_interactionB->isRegistered())
      covise::coInteractionManager::the()->unregisterInteraction(_interactionB);
  ...
  if(_interactionC)
  {
    if(_interactionC->isRegistered())
      covise::coInteractionManager::the()->unregisterInteraction(_interactionC);
...
void PickBox::updateVertices(Geometry* geom)
{
  ...
  if (!vertices) vertices = new Vec3Array(24);
