...
*/
Marker::Marker(GeometryType gt, Interaction* interaction) : Widget(), Events()
{
...
/** Constructor. 
  @param interaction interaction class; NULL for no interaction
*/
Marker::Marker(GeometryType gt, Interaction* interaction, float size, Vec4& color) : Widget(), Events()
{
...
void Marker::init(GeometryType gt, Interaction* interaction, float size, Vec4& color)
{
  ...
  // INTERACTION
  //_interactionA = new covise::coTrackerButtonInteraction(covise::coInteraction::ButtonA,"MarkerMove",covise::coInteraction::Medium);
  //_interactionB = NULL;
