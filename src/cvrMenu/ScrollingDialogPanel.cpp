...
ScrollingDialogPanel::ScrollingDialogPanel(float textWidth, int textrows, float textscale, bool followEnd, std::string title, std::string configTag):
        PopupMenu(title,configTag)
{
    ...
    _text = "";
    _menuScrollText = new MenuScrollText(_text,_textWidth,_textRows,_textScale,false,followEnd);
